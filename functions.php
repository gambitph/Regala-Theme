...
function theme1_scripts() {
	...
	wp_enqueue_style( 'theme1-content-sidebar', get_template_directory_uri() . '/layouts/content-sidebar.css' );
    ...
    wp_enqueue_script( 'theme1-superfish', get_template_directory_uri() . '/js/superfish.min.js', array( 'jquery' ), '20140127', true );
    ...
    wp_enqueue_script( 'theme1-superfish-settings', get_template_directory_uri() . '/js/superfish-settings.js', array( 'theme1-superfish' ), '20150127', true );
